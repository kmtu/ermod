...
module sysvars
  ...
  character*3 :: slfslt='yes', infchk='not', ljlrc='not'
...
550    format('  Be sure that the solvent distribution is homegeneous (radial distribution function is unity) when the solvent is separated by distances of',f8.3,' or ',f8.3,' Angstrom in any direction from any atom within solute')
       write(6,*)
       call get_ljtable
